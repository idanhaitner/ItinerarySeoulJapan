  ...
  const DATA = {
    kr: {
      culture: {
        ...
        lead: "קוריאה מנומסת, אבל פחות נוקשה מיפן. מכבדים גיל, תורים ומרחב ציבורי. אף אחד לא מצפה לקידה מושלמת — כן מצפים שלא תצעקו ברכבת.",
        items: [
          ...
          { kind: "do", title: "אשפה בתיק", body: "בשתי המדינות כמעט אין פחים ברחוב. בקבוק ריק שומרים בתיק עד חנות נוחות או פח." },
      ...
      transit: {
        ...
        lead: "המטרו הוא ברירת המחדל. אוטובוסים משלימים, ומונית כשעייפים או עם מזוודות. Google Maps לא עובד לניווט רגלי או לתחבורה ציבורית בקוריאה — Kakao Map או Naver Map הן חובה.",
        how: [
          "טוענים T-Money במזומן במכונה בתחנה, או קונים Climate Card לימים בסיאול. מעבירים את הכרטיס בכניסה וביציאה.",
        ...
        tickets: [
          { name: "T-Money", tag: "יומיומי", body: "כרטיס רב־פעמי למטרו, לאוטובוס ולחנות נוחות. במכונות בתחנה טוענים במזומן בלבד — אשראי בינלאומי לא עובד שם. תקף גם מחוץ לסיאול, ב־AREX All-Stop וכגיבוי ל־Climate Card." },
      ...
      food: {
        ...
        items: [
          ...
          { kind: "do", title: "כפית ומקלות מתכת", body: "את האורז אוכלים בכפית, ואת מנות הצד (הבנצ׳אן) אוכלים במקלות. לא תוקעים את המקלות זקוף בתוך הקערה." },
          { kind: "do", title: "בשר על השולחן", body: "בברביקיו חותכים במספריים, עוטפים בחסה, ולא מערמים נתח ענק בבת אחת." },
          { kind: "do", title: "חנות נוחות", body: "ב־CU, GS25 ו־7‑Eleven אפשר לאכול ארוחת לילה שלמה: משקאות, קים־באפ וראמן. בחלק מהסניפים יש פינת ישיבה ומיקרוגל לחימום עצמי." },
          { kind: "dont", title: "קריאה למלצר", body: "קוראים למלצר בהרמת יד עדינה קרוב לגוף, או ב־«yogiyo». לא שורקים ולא מנופפים בידיים." },
      ...
      stay: {
        ...
        items: [
          { kind: "do", title: "צ׳ק־אין בסביבות 15:00", body: "ב־9 Brick בהונגדה אפשר לבקש להשאיר מזוודות אם מגיעים מוקדם. נעלי הבית נשארות בחדר — לא יוצאים איתן ללובי." },
      ...
      extra: {
        title: "כסף וחירום",
        bits: [
          "כרטיס אשראי עובד כמעט בכל מקום בסיאול. מזומן שימושי בקיוסקים, בשוק, ובהטענת T-Money במכונות בתחנה.",
    ...
    jp: {
      culture: {
        ...
        items: [
          ...
          { kind: "do", title: "אשפה איתכם", body: "כמעט אין פחים ברחוב, כמו בקוריאה. ליד מכונות שתייה יש מיחזור לבקבוקים ולפחיות — מפרידים שם. שאר האשפה נשארת בתיק עד חנות נוחות או המלון." },
          ...
          { kind: "do", title: "מדרגות נעות", body: "בטוקיו עומדים בשמאל. באוסקה ובקיוטו לרוב עומדים בימין. אם לא בטוחים — פשוט עומדים בצד וזורמים עם הטור שלפניכם." },
          { kind: "do", title: "נעליים בגנקאן", body: "בכניסה לריוקאן, למקדשים מסוימים ולמסעדות טאטאמי חולצים נעליים בגנקאן. בשירותים לפעמים יש כפכפים נפרדים." },
        ],
      },
      transit: {
        kicker: "02 · תחבורה",
        ...
        how: [
          "מוסיפים Suica או Pasmo לאייפון או לאנדרואיד לפני הנחיתה, או קונים Welcome Suica פיזי בשדה. במכונות בתחנה טוענים במזומן בלבד. מעבירים בכניסה וביציאה. אותו כרטיס עובד בטוקיו, בקיוטו ובאוסקה.",
        ...
        tickets: [
          { name: "Suica / Pasmo", tag: "יומיומי", body: "כרטיס IC באייפון, באנדרואיד או בפלסטיק. במכונות בתחנה טוענים במזומן בלבד — אשראי בינלאומי לא עובד שם. בארנק בטלפון אפשר להטעין גם מהאפליקציה. תקף במטרו, ברכבת עירונית ובחנות נוחות בטוקיו, בקיוטו ובאוסקה." },
          ...
          { name: "אוטובוס שינג׳וקו–קוואגוצ׳יקו", tag: "בין־עירוני", body: "מושב שמור מטרמינל Busta Shinjuku, קומה 4, ב־7/9. יציאה 09:15, הגעה לתחנת קוואגוצ׳יקו 11:15." },
      ...
      food: {
        ...
        items: [
          ...
          { kind: "do", title: "שאיבת אטריות", body: "שאיבת אטריות בקול (Slurping) בראמן ובסובה מקובלת לחלוטין, ואף נחשבת מחמאה לשף. בסושי אוכלים בעדינות רבה יותר." },
          { kind: "info", title: "אוטושי", body: "באיזקאיה לעיתים מגיעה מנת פתיחה בתשלום, גם בלי שהוזמנה. זו לא טעות — אלה דמי שולחן." },
          { kind: "do", title: "חנות נוחות", body: "ב־7‑Eleven, FamilyMart ו־Lawson יש ארוחות חמות, ביצים וקפה ממכונה. בחלק מהסניפים יש פינת ישיבה ומיקרוגל לחימום עצמי." },
      ...
      stay: {
        ...
        items: [
          { kind: "do", title: "צ׳ק־אין ב־17:00 בהקונה", body: "ב־Zagakukan הצ׳ק־אין ב־17:00 והצ׳ק־אאוט ב־13:00. אפשר להשאיר תיקים בדלפק אם מגיעים מוקדם. אין שעת קייסקי קבועה." },
          ...
          { kind: "info", title: "קעקועים", body: "חלק מהמקומות עדיין מגבילים קעקועים. ב־MYSTAYS וב־Zagakukan כדאי לשאול בדלפק. לקעקוע קטן כדאי להצטייד מראש במדבקות כיסוי בגוון העור (Tattoo cover stickers)." },
          { kind: "do", title: "יוקאטה", body: "בריוקאן לובשים את היוקאטה כשהצד השמאלי מעל הימני. סגירה הפוכה, ימין מעל שמאל, מיועדת להלבשת נפטרים בהלוויות — לכן היפנים רגישים לזה. אפשר לאכול וללכת במסדרון בחלוק." },
          { kind: "do", title: "אסלה יפנית / Washlet", body: "על האסלה היפנית (Washlet) יש שלט עם כפתורים. אם לא בטוחים — לוחצים על כפתור ההדחה הגדול. ברוב המלונות זורקים נייר לאסלה; רק אם יש שלט מפורש — עושים אחרת." },
      ...
      extra: {
        title: "כסף וחירום",
        bits: [
          "כרטיס אשראי עובד בערים הגדולות. מזומן עדיין שימושי בהקונה, בקוואגוצ׳יקו, בדוכנים, ובהטענת Suica או Pasmo במכונות בתחנה.",
