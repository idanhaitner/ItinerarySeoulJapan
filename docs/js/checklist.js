  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "k-secret", label: "גן הסודי ב־Changdeokgung (שבת 29 באוג׳)", window: "להזמין מוקדם ככל האפשר", priority: "high" },
        ...
        {
          id: "s-skin",
          label: "טיפול פנים ב־Seoulistique בסאונגסו (@seoulistique.skin)",
