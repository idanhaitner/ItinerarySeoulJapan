  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        {
          id: "hk-kw-bus",
          label: "אוטובוס בין-עירוני משינג׳וקו לקוואגוצ׳יקו (07/9) — מושב שמור מטרמינל Busta Shinjuku (Keio או Fujikyu), כשעתיים",
          window: "להזמין מראש",
          priority: "high",
        ...
        {
          id: "j-odawara-kyoto",
          label: "שינקנסן Hikari מאודאווארה לקיוטו (10/9 ערב) — מושבים שמורים ב־SmartEX, כשעתיים. רוב רכבות Nozomi לא עוצרות באודאווארה",
          window: "להזמין ~30 יום לפני / כשנפתח · יציאה סביב 17:15",
          priority: "critical",
        ...
        {
          id: "g-luggage",
          label: "אופציונלי: לשלוח מזוודות מ־Hotel Gracery ל־MYSTAYS בערב 6/9 או בבוקר 7/9. אחרת הן נוסעות איתכם באוטובוס לקוואגוצ׳יקו",
          window: "6 בספט׳ ערב או בוקר 7/9",
          priority: "medium",
        },
        {
          id: "g-luggage-kyoto",
          label: "שילוח מזוודות מ־MYSTAYS ל־KABIN Koji בבוקר 09/9 (Yamato, כ־¥2,000–2,500 למזוודה). יגיעו לקיוטו ב־10/9. להקונה נוסעים עם תיק גב בלבד",
    ...
    },
    {
      ...
      items: [
        {
          id: "h-hakone",
          label: "Tsukino Yado Sara — לשנות לילה מ־07/9 ל־09/9 (צ׳ק־אאוט 10/9 לשינקנסן לקיוטו)",
        ...
        {
          id: "h-kyoto",
          label: "KABIN Koji — להוסיף לילה 10/9 להזמנה הקיימת (לילות 10–14/9 · צ׳ק־אאוט 15/9)",
          window: "Kawaramachi / 筋屋町152 · איסוף מזוודות בערב 10/9",
          priority: "critical",
          done: false,
          linkCheckin: true,
        ...
        { id: "ky-fushimi", label: "פושימי אינארי מוקדם ב־12/9, ואז אוג׳י ונישיקי עד ~16:00 (קיומיזו היה ב־11/9)", window: "12 בספט׳", priority: "low" },
        { id: "ky-bags", label: "איסוף מזוודות שנשלחו מקוואגוצ׳יקו, בדלפק KABIN", window: "צ׳ק־אין 10/9 ערב", priority: "medium" },
