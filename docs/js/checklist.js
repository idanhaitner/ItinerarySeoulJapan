  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "k-secret", label: "גן הסודי ב־Changdeokgung (שבת 29 באוג׳ — סגור בימי שני)", window: "להזמין מוקדם ככל האפשר", priority: "high" },
        { id: "k-lotte", label: "כרטיסים ללוטה וורלד (יום שני 31 באוג׳ — פחות עמוס מסוף שבוע)", window: "להזמין 2–4 שבועות לפני", priority: "high" },
        { id: "k-ntower", label: "כרטיסים ל־N Seoul Tower (שקיעה · יום א׳ 30 באוג׳)", window: "להזמין 1–2 שבועות לפני", priority: "medium" },
        {
          id: "s-unni",
          label: "תור Unni Guide Center בגנגנאם (+ טיפול דרכם)",
          window: "להזמין 1–3 שבועות לפני · שבת 29 באוג׳ אחה״צ",
          priority: "high",
        },
        {
          id: "s-skin",
          label: "טיפול פנים ב־Seoulistique בסאונגסו (Instagram @seoulistique.skin / WhatsApp)",
          window: "להזמין 1–3 שבועות לפני · יום א׳ 30 באוג׳",
          priority: "high",
        },
        {
          id: "s-jimjilbang",
          label: "ג׳ימג׳ילבאנג ליד Jamsil אחרי לוטה (ערב קצר + ארוחה בלבד)",
          window: "31 באוג׳ בערב",
          priority: "medium",
        },
      ],
