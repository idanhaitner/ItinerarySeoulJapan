  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "j-shibuya-sky", label: "כרטיס שקיעה ל־Shibuya Sky", window: "להזמין ~4 שבועות לפני", priority: "high" },
        {
          ...
          label: "כרטיסי teamLab Planets Tokyo (Toyosu) לפי שעה",
          window: "להזמין 2–6 שבועות לפני · 5 בספט׳",
          priority: "high",
        },
        {
          id: "j-street-kart",
          label: "Street Kart Tokyo — הזמנה + רישיון נהיגה בינלאומי פיזי (IDP)",
          window: "6 בספט׳ · להזמין מראש",
          priority: "high",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "ky-nintendo",
          label: "Nintendo Museum (Uji) — הגרלת/הזמנת כרטיסים",
          window: "להירשם להגרלה מראש · 11 בספט׳",
          priority: "high",
        },
        {
          id: "ky-kawadoko",
        ...
        { id: "ky-fushimi", label: "יציאה מוקדמת ל־Fushimi Inari + רכבת לאוג'י", window: "11 בספט׳", priority: "medium" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "כרטיסי teamLab Botanical Garden Osaka (ערב / אחרי חשיכה)",
          window: "להזמין מראש · 15 בספט׳",
          priority: "high",
        },
    ...
    },
    {
      ...
      items: [
        {
          id: "h-tokyo2",
          label: "מלון בשינג׳וקו (20–24 בספט׳) — קרוב לנאקאנו / N'EX",
          window: "להזמין בהקדם",
          priority: "high",
        },
        { id: "t2-return-train", label: "שינקנסן אוסקה → טוקיו", window: "להזמין ~30 יום לפני", priority: "high" },
        { id: "t2-nikko", label: "רכבת מוקדמת לניקו (Toshogu / Chuzenji / Kegon)", window: "21 בספט׳", priority: "medium" },
        { id: "t2-kamakura", label: "יום קמאקורה + Enoden לאנושימה", window: "22 בספט׳", priority: "medium" },
        { id: "t2-airport", label: "N'EX / רכבת לנריטה או האנדה לפי הטיסה", window: "כשיודעים שדה תעופה", priority: "high" },
        { id: "t2-farewell", label: "הזמנת ארוחת פרידה (וואגיו / אומקאסה)", window: "1–2 שבועות לפני · 23 בספט׳", priority: "medium" },
      ],
    },
  ],
};
