    ...
    jp: {
      ...
      stay: {
        ...
        items: [
          ...
          { kind: "info", title: "קעקועים", body: "חלק מהמקומות עדיין מגבילים קעקועים. ב־MYSTAYS וב־Sara כדאי לשאול בדלפק. לקעקוע קטן כדאי להצטייד מראש במדבקות כיסוי בגוון העור (Tattoo cover stickers)." },
