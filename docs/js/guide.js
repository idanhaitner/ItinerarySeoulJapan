    ...
    kr: {
      ...
      food: {
        ...
        items: [
          ...
          { kind: "do", title: "חנות נוחות", body: "CU, GS25 ו־7‑Eleven הם ארוחת לילה לגיטימית: משקאות, קים־באפ, ראמן." },
      ...
      stay: {
        ...
        items: [
          ...
          { kind: "do", title: "ג׳ימג׳ילבאנג", body: "ספא קוריאני: בגדים בחדר הלבשה, בגדי ספא בפנים (לא עירום כמו אונסן יפני). יש אזורים חמים, קרים ואוכל." },
    ...
    jp: {
      ...
      food: {
        ...
        items: [
          ...
          { kind: "do", title: "נוחות", body: "7‑Eleven, FamilyMart, Lawson: ארוחות חמות, ביצים, קפה מכונה." },
