  ...
  const DATA = {
    ...
    jp: {
      ...
      transit: {
        ...
        how: [
          "מוסיפים Suica או Pasmo לאייפון או לאנדרואיד, או קונים כרטיס פלסטיק בהגעה. במכונות בתחנה טוענים במזומן בלבד. מעבירים בכניסה וביציאה. אותו כרטיס עובד בטוקיו, בקיוטו ובאוסקה.",
