...
def build_bookings(days):
    ...
    items = [
        ...
        ("Unni Guide Center", "d03", "לטפל", "15:00–16:00 · אחריו Moclock לא טיפול קליניקה"),
        ("Moclock Gangnam — טיפול שיער (שחר)", "d03", "לטפל", "29 באוג׳ · 17:00 · יציאה 3 בנונהיון · לאשר תור שבת"),
...
def build_ideas():
    return [
        ...
        ["סאונגסו / יער סיאול בערב שבת", "סיאול", "נמוך", "לדלג", "חנויות נסגרות ~20:00 והרחוב נהיה שקט — במקום זה COEX ואז קניון לילי בדונגדאמון"],
    ]
