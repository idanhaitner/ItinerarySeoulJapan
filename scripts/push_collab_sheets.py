...
def build_bookings(days):
    ...
    items = [
        ...
        ("Street Kart Tokyo — סלוט ערב", "d11", "לטפל", "06/9 · ~19:00 · IDP פיזי"),
        ...
        ("שינקנסן Hikari מאודאווארה לקיוטו", "d15", "לטפל", "10/9 ערב · SmartEX · יציאה סביב 17:15"),
        ("שינקנסן Nozomi מאוסקה לטוקיו", "d26", "לטפל", "21/9 · SmartEX"),
        ("Tobu Spacia X לניקו", "d27", "לטפל", "22/9 · יציאה ~06:30 מאסאקוסה"),
        ("Tsukino Yado Sara — לשנות לילה ל־09/9", "d14", "לטפל", "כרגע הוזמן 07/9 · הגעה ~16:30"),
        ("KABIN Koji — להוסיף לילה 10/9", "d15", "לטפל", "הזמנה קיימת 11–15/9"),
