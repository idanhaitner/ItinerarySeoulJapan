...
def build_bookings(days):
    ...
    items = [
        ...
        ("ארוחת Hirobun בקיבונה", "d19", "לטפל", "14/9 · kawadoko ב־ひろ文 · TEL 075-741-2147 / hirobun.co.jp · ישיבות ~11:00 או 13:00"),
        ...
        ("טיסת אמירייטס נריטה → דובאי → טירנה", "d30", "לטפל", "Emirates · NRT → DXB → TIA · לאשר מספרי טיסה ושעות"),
