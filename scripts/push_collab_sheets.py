...
def build_hotels(days):
    ...
    meta = {
        ...
        ("Hakone", 0): ("הקונה", "Hakone-Yumoto", "Tsukino Yado Sara (月の宿 紗ら)", "לטפל", "לשנות לילה מ־07/9 ל־09/9 · צ׳ק־אאוט 10/9 לשינקנסן לקיוטו · קייסקי + אונסן אחרי אוטובוס ישיר מגוטמבה"),
        ("Kawaguchiko", 0): ("קוואגוצ׳יקו", "Fujiyoshida / ליד Fuji-Q", "HOTEL MYSTAYS Fuji Onsen Resort", "הוזמן", "לילות 7–8/9 · צ׳ק־אאוט 9/9 לגוטמבה"),
        ("Kyoto", 0): ("קיוטו", "Kawaramachi / Shijo", "KABIN Koji", "לטפל", "להוסיף לילה 10/9 · לילות 10–14/9 · צ׳ק־אאוט 15/9 · שינקנסן מאודאווארה בערב 10/9"),
    ...
    for block in _stay_ranges(days):
        ...
        if city == "Hakone":
            ...
            notes = "לשנות לילה מ־07/9 ל־09/9 · צ׳ק־אאוט 10/9 לשינקנסן לקיוטו · הגעה ~16:30 אחרי אוטובוס ישיר מגוטמבה · קייסקי + אונסן (ספינה מחר במעגל)"
        if city == "Kawaguchiko":
        ...
        if city == "Kyoto":
            ...
            notes = "להוסיף לילה 10/9 להזמנה הקיימת (11–15/9) · 下京区筋屋町152 · Hikari מאודאווארה בערב 10/9 · איסוף מזוודות בהגעה"
        if city == "Osaka":
...
def build_bookings(days):
    ...
    items = [
        ...
        # 3 · Transport
        ("אוטובוס בין-עירוני משינג׳וקו לקוואגוצ׳יקו", "d12", "לטפל", "07/9 · מושב שמור מטרמינל Busta Shinjuku (Keio או Fujikyu) · כשעתיים"),
        ("אוטובוס מקוואגוצ׳יקו לאאוטלט גוטמבה + הקונה־יומוטו", "d14", "לטפל", "09/9 בוקר · כשעה לגוטמבה · אחרי הקניות אוטובוס ישיר להקונה־יומוטו כ־45–60 דק׳ (לא דרך Togendai)"),
        ("שינקנסן Hikari מאודאווארה לקיוטו", "d15", "לטפל", "10/9 ערב · מושבים שמורים ב־SmartEX · יציאה סביב 17:15 · רוב רכבות Nozomi לא עוצרות באודאווארה"),
        ...
        ("שילוח מזוודות מ־MYSTAYS ל־KABIN Koji", "d14", "לטפל", "09/9 בבוקר לפני גוטמבה · כ־¥2,000–2,500 למזוודה · יגיעו ל־KABIN בערב 10/9"),
        # 4 · Stays / experiences
        ("Tsukino Yado Sara — ריוקאן הקונה", "d14", "לטפל", "לשנות 07/9 → 09/9 · Hakone-Yumoto · קייסקי + אונסן · הגעה ~16:30 אחרי אוטובוס מגוטמבה · צ׳ק־אאוט 10/9 לשינקנסן"),
        ("Hotel Gracery Shinjuku — טוקיו התחלה", "d07", "הוזמן", "2–7/9 · Kabukicho 1-19-1 · בניין Godzilla"),
        ("מלון קוואגוצ׳יקו — MYSTAYS Fuji Onsen", "d12", "הוזמן", "לילות 7–8/9 · צ׳ק־אאוט 9/9 לגוטמבה · Fuji-Q ב־8/9 ליד"),
        ("KABIN Koji — מלון קיוטו", "d15", "לטפל", "להוסיף לילה 10/9 להזמנה 11–15/9 · 筋屋町152 · Kawaramachi · איסוף מזוודות בערב 10/9"),
