...
def build_hotels(days):
    ...
    for block in _stay_ranges(days):
        ...
        if city == "Hakone":
            ...
            notes = "הוזמן · לילה 9/9 · צ׳ק־אאוט 10/9 לשינקנסן לקיוטו · הגעה ~15:30 אחרי אוטובוס ישיר מגוטמבה · קייסקי + אונסן (ספינה מחר במעגל)"
        if city == "Kawaguchiko":
...
def build_bookings(days):
    ...
    items = [
        ...
        ("Tsukino Yado Sara", "d14", "הוזמן", "לילה 9/9 · צ׳ק־אאוט 10/9 · הגעה ~15:30 אחרי גוטמבה"),
