...
def build_hotels(days):
    ...
    meta = {
        ...
        ("Hakone", 0): ("הקונה", "Hakone-Yumoto", "Tsukino Yado Sara (月の宿 紗ら)", "לטפל", "לשנות לילה מ־07/9 ל־09/9 · צ׳ק־אאוט 10/9 · קייסקי + אונסן אחרי אוטובוס ישיר מגוטמבה"),
    ...
    for block in _stay_ranges(days):
        ...
        if city == "Hakone":
            ...
            notes = "לשנות לילה מ־07/9 ל־09/9 · צ׳ק־אאוט 10/9 · הגעה ~16:30 אחרי אוטובוס ישיר מגוטמבה · קייסקי + אונסן (ספינה מחר במעגל)"
        if city == "Kawaguchiko":
...
def build_bookings(days):
    ...
    items = [
        ...
        # 4 · Stays / experiences
        ("Tsukino Yado Sara — ריוקאן הקונה", "d14", "לטפל", "לשנות 07/9 → 09/9 · Hakone-Yumoto · קייסקי + אונסן · הגעה ~16:30 אחרי אוטובוס ישיר מגוטמבה"),
