...
def build_hotels(days):
    ...
    meta = {
        ...
        ("Hakone", 0): ("הקונה", "Hakone-Yumoto", "Tsukino Yado Sara (月の宿 紗ら)", "לטפל", "לשנות לילה מ־07/9 ל־09/9 · צ׳ק־אאוט 10/9 · קייסקי + אונסן אחרי גוטמבה והשייט"),
    ...
    for block in _stay_ranges(days):
        ...
        if city == "Hakone":
            ...
            notes = "לשנות לילה מ־07/9 ל־09/9 · צ׳ק־אאוט 10/9 · הגעה ~18:00 אחרי גוטמבה + ספינת פיראטים · קייסקי + אונסן"
        if city == "Kawaguchiko":
...
def build_bookings(days):
    ...
    items = [
        ...
        ("אוטובוס מקוואגוצ׳יקו לאאוטלט גוטמבה + Togendai", "d14", "לטפל", "09/9 בוקר · ~50–70 דק׳ לגוטמבה · אחרי הקניות אוטובוס ל־Togendai לשייט"),
        ...
        ("Takkyubin מזוודות מ־MYSTAYS ל־KABIN Koji", "d14", "לטפל", "09/9 בבוקר לפני גוטמבה · שיגיעו ל־KABIN ב־10/9"),
        # 4 · Stays / experiences
        ("Tsukino Yado Sara — ריוקאן הקונה", "d14", "לטפל", "לשנות 07/9 → 09/9 · Hakone-Yumoto · קייסקי + אונסן · הגעה ~18:00 אחרי גוטמבה והשייט"),
